...
describe('Predefined Nodes Test', function () {
  ...
  it('CodeBlock', function () {
    let json = {
      type: 'doc',
      content: [{ type: 'code_block', content: [{ type: 'text', text: 'Example Text' }] }],
    };
  ...
  it('Ordered List', function () {
    let json = {
      ...
      content: [
        {
          type: 'ordered_list',
          content: [{ type: 'list_item', content: [{ type: 'text', text: 'first list item' }] }],
        },
      ],
    };
  ...
  it('Paragraph', function () {
    let json = {
      type: 'doc',
      content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Example Paragraph' }] }],
    };
